...
describe SessionsController do
  describe "route generation" do
    it "should route {:controller => 'sessions', :action => 'new'} to /login" do
    ...
    it "should route {:controller => 'sessions', :action => 'destroy'} to /logout" do
      route_for(:controller => 'sessions', :action => 'destroy').should == "/logout"
    end
  end
  
  describe "route recognition" do
    it "should generate params {:controller => 'sessions', :action => 'new'} from GET /login" do
