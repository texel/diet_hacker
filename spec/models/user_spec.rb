...
describe User do
 ...
 if REST_AUTH_SITE_KEY.blank? 
  ...
  describe "associations" do
    it "should have data_points" do
      users(:quentin).data_points.should_not be_nil
    end
    
    it "should have data points for a particular day" do
      user = users(:quentin)
      data_point = DataPoint.create(:weight => 155, :date => Date.today)
      user.data_points << data_point
      user.save
      user.data_points.for_date(Date.today).first.should == data_point
    end
  end
